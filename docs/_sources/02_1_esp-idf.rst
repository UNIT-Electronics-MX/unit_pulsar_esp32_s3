...
4. **Install Additional Tools**  
   For ESP32-H2-specific tools, run:
   ...
   .. note::
      ...
      The `install.sh` script downloads and installs the required tools and dependencies for the ESP32-H2 chip. The duration depends on your internet speed.
...
4. **Flash the Application**  
   Connect your ESP32-H2 board to your computer and flash the application:
...
5. **Monitor the Output**  
   Monitor the output from the ESP32-H2 board:
